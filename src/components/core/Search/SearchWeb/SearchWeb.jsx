    ...
    <div className="relative">
      <div
        className={`relative overflow-hidden ${
          searchOpen
            ? "2xl:w-[40vw] w-[45vw] rounded-3xl bg-richblack-5"
      ...
      >
        <input
          ...
          } transition-all duration-1000 h-[35px] bg-richblack-5 border-none outline-none font-semibold text-richblack-5`}
        />
        <button
          onClick={() => {
